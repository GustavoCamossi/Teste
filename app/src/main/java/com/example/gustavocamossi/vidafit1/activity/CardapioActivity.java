...
import static c.e.g.v.dialog.MessagemAlerta.mensagemDialog;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menuPedido:
                if (qtdItensCarrinho > 0)
                    ...
                    mensagemDialog(this,"Pedido Confirmado", "Seu pedido foi confirmado com sucesso!", null);
                }
                break;
        }
    ...
    private void confirmarPedido() {
        ...
        builder.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mensagemDialog(context,"Pedido Confirmado", "Seu pedido foi confirmado com sucesso!", null);
